  ...
  function _listsConnected(destination, origin) {
    ...
    if (destination.isSortable === true) {
      ...
      if (
        ...
        return (
          store(destination).getConfig('connectWith') === store(origin).getConfig('connectWith')
        );
      }
    }
    return false;
    ...
    if (typeof store(sortableContainer).getConfig('hoverClass') === 'string') {
      ...
      if (enable === true) {
        ...
        addEventListener(sortableContainer, 'mouseleave', function() {
          _filter(sortableContainer.children, store(sortableContainer).getConfig('items')).forEach(
            function(item) {
              (_a = item.classList).remove.apply(_a, hoverClasses_1);
              var _a;
            }
    ...
    sortableElements.forEach(function(sortableElement) {
      ...
      var onDragOverEnter = function(e) {
        ...
        if (
          ...
          _filter(sortableElement.children, addData(sortableElement, 'items')).length >=
            parseInt(options.maxItems) &&
